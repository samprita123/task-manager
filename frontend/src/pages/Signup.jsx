...
// export default function Signup({ setAuth, setRole, setEmail }) {
...
//       // Validations
//       if (!name.trim() || !emailInput.trim() || !password.trim()) {
...
//             body: JSON.stringify({ name, email: emailInput, password, role: selectedRole })
//          });
...
//                   <p className="text-gray-400">Create your account and select your workspace role.</p>
//                </div>

//                <form onSubmit={handleSignup} className="space-y-6">
//                   <div>
//                      <label className="block text-sm font-medium text-gray-400 mb-4">Select Role to Join As</label>
...
//                   Already have an account? <span onClick={() => navigate('/login')} className="text-white hover:text-primary transition cursor-pointer font-medium">Sign in</span>
//                </p>
//             </motion.div>
//          </div>
...
//                <h1 className="text-5xl font-bold text-white mb-6">Scale Operations</h1>
//                <p className="text-xl text-gray-300 max-w-md mx-auto">Get connected in seconds and start distributing your tasks seamlessly.</p>
//             </div>
//          </div>
//       </div>
//    );
